	...
	<body>
		<div class="admin-main">
			...
			<blockquote class="layui-elem-quote">
				...
				<a href="student-list" class="layui-btn layui-btn-small" id="fluse">
					<i class="layui-icon">&#x1002;</i> 刷新
				</a>
				<form class="layui-form" style="float:right;">
	                <div class="layui-form-item" style="margin:0;">
	                    <div class="layui-input-inline">
	                        <input type="text" name="username" placeholder="请输入学员姓名.." autocomplete="off" class="layui-input">
	                    </div>
		...
		<script>
			...
			layui.use(['paging', 'form','laydate'], function() {
                ...
                paging.init({
                    openWait: true,
                    url: 'getStudentList?username=${username}', //地址
					elem: '#content', //内容容器
					params: { //发送到服务端的参数
					},
					type: 'GET',
				...
				$('#add').on('click', function() {
					if(addBoxIndex !== -1)
						return;
					//本表单通过ajax加载 --以模板的形式，当然你也可以直接写在页面上读取
					$.get('student-add', null, function(form) {
						addBoxIndex = layer.open({
							type: 1,
							title: '添加学员',
							content: form,
