...
<div style="margin: 15px;">
	<form class="layui-form">
		<div class="layui-form-item">
			...
			<div class="layui-input-inline" style="width: 100px;">
				<input type="text" name="preachTime" lay-verify="required"
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline" style="width: 100px;">
				<input type="text" name="charge" lay-verify="required"
					autocomplete="off" class="layui-input">
			</div>
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline" style="width: 100px;">
				<input type="text" name="joinPerson" lay-verify=""
					autocomplete="off" class="layui-input">
			</div>
			<label class="layui-form-label">学生人数</label>
			<div class="layui-input-inline" style="width: 100px;">
				<input type="text" name="stuNumber" lay-verify="required|number"
