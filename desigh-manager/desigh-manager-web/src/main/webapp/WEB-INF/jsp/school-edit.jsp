...
<div style="margin: 15px;">
	<form class="layui-form">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline" style="width: 100px;">
				<input type="text" name="department" value="${school.department }"
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline" style="width: 100px;">
				<input type="text" name="linkman" value="${school.linkman }"
					lay-verify="required" autocomplete="off" placeholder=""
					class="layui-input">
			</div>
			<label class="layui-form-label">联系电话</label>
			<div class="layui-input-inline" style="width: 100px;">
				<input type="tel" name="telphone" value="${school.telphone }"
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline" style="width: 100px;">
				<input type="text" name="linkmanPost" value="${school.linkmanPost }"
					lay-verify="" autocomplete="off" class="layui-input">
			</div>
			<label class="layui-form-label">办公室地址</label>
			<div class="layui-input-inline" style="width: 100px;">
				<input type="text" name="officeAddress"
					value="${school.officeAddress }" lay-verify="" autocomplete="off"
					class="layui-input">
			</div>
		</div>
