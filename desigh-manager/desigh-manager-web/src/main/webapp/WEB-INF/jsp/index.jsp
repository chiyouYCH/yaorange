...
<body>
	<div class="layui-layout layui-layout-admin"
			...
			<div class="layui-main">
				<div class="admin-login-box">
					<a class="logo" style="left: 0;"
						...
						style="font-size: 18px;">雅橙面试事管理系统</span>
					</a>
				...
				<ul class="layui-nav admin-header-item">
					<li class="layui-nav-item"><a href="javascript:;"
						class="admin-header-user"> <img src="images/0.jpg" /> <span>${sessionScope.username }</span>
					</a>
						<dl class="layui-nav-child">
							...
							<dd>
								<a href="loginout"><i class="fa fa-sign-out"
		...
		<script type="text/javascript" src="datas/nave.js"></script>
