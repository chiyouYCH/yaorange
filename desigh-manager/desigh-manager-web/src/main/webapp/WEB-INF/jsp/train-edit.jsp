	...
	<form class="layui-form">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline" style="width: 100px;">
				<input type="text" name="school" value="${train.school }" required
					lay-verify="required" autocomplete="off" class="layui-input">
			</div>
			<label class="layui-form-label">实训时间</label>
			<div class="layui-input-inline" style="width: 100px;">
				<input type="text" name="trainTime" lay-verify="" autocomplete="off"
					class="layui-input" onclick="layui.laydate({elem: this})"
					value="<fmt:formatDate value="${train.trainTime }" pattern="yyyy-MM-dd" />">
			</div>
		</div>
		<div class="layui-form-item">
			<label class="layui-form-label">详细地点</label>
			<div class="layui-input-inline" style="width: 100px;">
				<input type="text" name="local" value="${train.local }"
					lay-verify="required" autocomplete="off" class="layui-input">
			</div>
			<label class="layui-form-label">学生人数</label>
			<div class="layui-input-inline" style="width: 100px;">
				<input type="text" name="trainNumber" value="${train.trainNumber }"
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline" style="width: 100px;">
				<input type="text" name="engineerNumber"
					value="${train.engineerNumber }" lay-verify="required|number"
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline" style="width: 300px;">
				<textarea name="trainContent" lay-verify="" placeholder="请输入"
					class="layui-textarea">${train.trainContent }</textarea>
			</div>
		</div>
