...
<div style="margin: 15px;">
	<form class="layui-form">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline" style="width: 100px;">
				<input type="text" name="corporateContact"
					value="${visit.corporateContact }" lay-verify="" autocomplete="off"
					class="layui-input">
			</div>
		</div>
		<div class="layui-form-item">
			...
			<div class="layui-input-inline" style="width: 100px;">
				<input type="tel" name="telephone" value="${visit.telephone }"
					lay-verify="phone" autocomplete="off" class="layui-input">
			</div>
			<label class="layui-form-label">回访人</label>
			<div class="layui-input-inline" style="width: 100px;">
				<input type="text" name="revisit" value="${visit.revisit }"
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline" style="width: 100px;">
				<input type="text" name="visitTime" lay-verify="" autocomplete="off"
					class="layui-input" onclick="layui.laydate({elem: this})"
					value="<fmt:formatDate value="${visit.visitTime }" pattern="yyyy-MM-dd" />">
			</div>
		</div>
		<div class="layui-form-item">
