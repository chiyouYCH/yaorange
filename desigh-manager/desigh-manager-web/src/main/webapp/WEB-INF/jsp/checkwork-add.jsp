...
<div style="margin: 15px;">
	<form class="layui-form">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline" style="width: 100px;">
				<input type="text" name="month" lay-verify="" placeholder="yyyy-MM"
					autocomplete="off" class="layui-input"
					onclick="layui.laydate({elem: this,format: 'YYYY-MM'})">
			</div>
			<label class="layui-form-label">迟到次数</label>
			<div class="layui-input-inline" style="width: 100px;">
				<input type="text" name="late" value="0" lay-verify="number"
					autocomplete="off" class="layui-input">
			</div>
		</div>
		<div class="layui-form-item">
			...
			<div class="layui-input-inline" style="width: 100px;">
				<input type="text" name="absence" value="0" lay-verify="number"
					autocomplete="off" class="layui-input">
			</div>
			<label class="layui-form-label">请假次数</label>
			<div class="layui-input-inline" style="width: 100px;">
				<input type="text" name="askforleave" value="0" lay-verify="number"
					autocomplete="off" class="layui-input">
			</div>
		</div>
