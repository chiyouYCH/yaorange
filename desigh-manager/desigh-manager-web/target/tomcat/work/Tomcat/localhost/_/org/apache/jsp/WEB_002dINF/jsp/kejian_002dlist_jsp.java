 ...
 * Generated at: 2018-04-19 13:45:03 UTC
...
public final class kejian_002dlist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t<i class=\"layui-icon\">&#xe608;</i> 添加课件信息\n");
      out.write("\t\t\t\t</a>\n");
      ...
      out.write("\t\t\t\t</a>\n");
      out.write("\t\t\t\t<a href=\"kejian-list\" class=\"layui-btn layui-btn-small\" id=\"fluse\">\n");
      ...
      out.write("\t                        <input type=\"text\" name=\"name\" placeholder=\"请输入文件名..\" autocomplete=\"off\" class=\"layui-input\">\n");
      out.write("\t                    </div>\n");
      ...
      out.write("\t\t\t\t<td><a href=\"{{ item.fn }}\" target=\"_blank\"  class=\"layui-btn layui-btn-mini\">下载</a></td>\n");
      ...
      out.write("                    url: 'getKejianList?name=");
      ...
      out.write("\t\t\t\t\t\t\t\t\t  $.get(\"deleteKejian\",{id:id},function(data){\n");
      out.write("\t\t\t\t\t\t\t\t\t//返回结果并刷新页面\n");
      ...
      out.write("\t\t\t\t\t\t\t\t$.get('kejian-edit', {id:id}, function(form) {\n");
      ...
      out.write("\t\t\t\t\tlayer.confirm('您确认删除吗?', {icon: 3, title:'提示'}, function(index){\n");
      out.write("\t\t\t\t\t\t  //do something\n");
      out.write("\t\t\t\t\t\t  $.get(\"deleteAllKejian\",{ids:ids},function(data){\n");
      out.write("\t\t\t\t\t\t//返回结果并刷新页面\n");
      out.write("\t\t\t\t\t\t   layerTips.msg(data.msg,{time:500},function(){\n");
      out.write("\t\t\t\t\t\t\t   layerTips.close(index);\n");
      out.write("\t\t\t\t\t\t\t\tlocation.reload(); //刷新\n");
      ...
      out.write("\t\t\t\t\t\treturn;\n");
      out.write("\t\t\t\t\t//本表单通过ajax加载 --以模板的形式，当然你也可以直接写在页面上读取\n");
      out.write("\t\t\t\t\t$.get('kejian-add', null, function(form) {\n");
      out.write("\t\t\t\t\t\taddBoxIndex = layer.open({\n");
      out.write("\t\t\t\t\t\t\ttype: 1,\n");
