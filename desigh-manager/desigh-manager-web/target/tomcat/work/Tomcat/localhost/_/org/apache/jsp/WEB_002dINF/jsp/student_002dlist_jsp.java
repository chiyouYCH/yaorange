 ...
 * Generated at: 2018-04-19 13:26:31 UTC
...
public final class student_002dlist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t<i class=\"layui-icon\">&#xe608;</i> 添加学员\n");
      out.write("\t\t\t\t</a>\n");
      ...
      out.write("\t\t\t\t</a>\n");
      out.write("\t\t\t\t<a href=\"student-list\" class=\"layui-btn layui-btn-small\" id=\"fluse\">\n");
      ...
      out.write("\t                        <input type=\"text\" name=\"username\" placeholder=\"请输入学员姓名..\" autocomplete=\"off\" class=\"layui-input\">\n");
      out.write("\t                    </div>\n");
      ...
      out.write("                    url: 'getStudentList?username=");
      ...
      out.write("\t\t\t\t\t\t\t\t\t  $.get(\"deleteStudent\",{id:id},function(data){\n");
      out.write("\t\t\t\t\t\t\t\t\t//返回结果并刷新页面\n");
      ...
      out.write("\t\t\t\t\t\t\t\t$.get('student-edit', {id:id}, function(form) {\n");
      out.write("\t\t\t\t\t\t\t\t\taddBoxIndex = layer.open({\n");
      out.write("\t\t\t\t\t\t\t\t\t\ttype: 1,\n");
      out.write("\t\t\t\t\t\t\t\t\t\ttitle: '修改学员信息',\n");
      ...
      out.write("\t\t\t\t\tlayer.confirm('您确认删除吗?', {icon: 3, title:'提示'}, function(index){\n");
      out.write("\t\t\t\t\t\t  //do something\n");
      out.write("\t\t\t\t\t\t  $.get(\"deleteAllStudent\",{ids:ids},function(data){\n");
      out.write("\t\t\t\t\t\t//返回结果并刷新页面\n");
      out.write("\t\t\t\t\t\t   layerTips.msg(data.msg,{time:500},function(){\n");
      out.write("\t\t\t\t\t\t\t   layerTips.close(index);\n");
      out.write("\t\t\t\t\t\t\t\tlocation.reload(); //刷新\n");
      ...
      out.write("\t\t\t\t\t\treturn;\n");
      out.write("\t\t\t\t\t//本表单通过ajax加载 --以模板的形式，当然你也可以直接写在页面上读取\n");
      out.write("\t\t\t\t\t$.get('student-add', null, function(form) {\n");
      out.write("\t\t\t\t\t\taddBoxIndex = layer.open({\n");
      out.write("\t\t\t\t\t\t\ttype: 1,\n");
      out.write("\t\t\t\t\t\t\ttitle: '添加学员',\n");
      out.write("\t\t\t\t\t\t\tcontent: form,\n");
      out.write("\t\t\t\t\t\t\tbtn: ['保存', '取消'],\n");
      out.write("\t\t\t\t\t\t\tshade: false,\n");
      out.write("\t\t\t\t\t\t\toffset: 'auto',\n");
