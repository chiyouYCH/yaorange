 ...
 * Generated at: 2018-04-19 13:43:37 UTC
...
public final class dagang_002dlist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t<i class=\"layui-icon\">&#xe608;</i> 添加教学大纲信息\n");
      out.write("\t\t\t\t</a>\n");
      out.write("\t\t\t\t<a href=\"#\" class=\"layui-btn layui-btn-small\" id=\"getSelected\">\n");
      out.write("\t\t\t\t\t<i class=\"fa fa-shopping-cart\" aria-hidden=\"true\"></i> 删除所选信息\n");
      out.write("\t\t\t\t</a>\n");
      out.write("\t\t\t\t<a href=\"dagang-list\" class=\"layui-btn layui-btn-small\" id=\"fluse\">\n");
      ...
      out.write("\t                        <input type=\"text\" name=\"name\" placeholder=\"请输入大纲名..\" autocomplete=\"off\" class=\"layui-input\">\n");
      out.write("\t                    </div>\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<th>大纲名称</th>\n");
      out.write("\t\t\t\t\t\t\t\t<th>大纲内容</th>\n");
      ...
      out.write("\t\t\t\t<td><a href=\"javascript:;\" data-id=\"{{ item.content }}\" data-opt=\"seeDesc\" class=\"layui-btn layui-btn-mini\">查看</a></td>\n");
      out.write("                <td>{{ null==item.createtime?'':layui.laytpl.toDateString(item.createtime,'yyyy-MM-dd') }}</td>\t\t\t\n");
      out.write("\t\t\t\t<td>\n");
      out.write("\t\t\t\t\t<a href=\"javascript:;\" data-id=\"{{ item.id }}\" data-opt=\"edit\" class=\"layui-btn layui-btn-mini\">编辑</a>\n");
      ...
      out.write("\t\t\t});\n");
      out.write("\t\t\t\n");
      out.write("\t\t\tlayui.use(['paging', 'form', 'laydate', 'upload'], function() {\n");
      ...
      out.write("\t\t\t\t\tvar name = $this.prev('input[name=name]').val();\n");
      out.write("\t\t\t\t\tif(name === '') {\n");
      ...
      out.write("                    url: 'getDagangList?name=");
      ...
      out.write("\t\t\t\t\t\t\t\t\t  $.get(\"deleteDagang\",{id:id},function(data){\n");
      out.write("\t\t\t\t\t\t\t\t\t//返回结果并刷新页面\n");
      ...
      out.write("\t\t\t\t\t\t});\n");
      out.write("\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t//绑定所有查看内容按钮事件\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t$('#content').children('tr').each(function() {\n");
      out.write("\t\t\t\t\t\t\tvar $that = $(this);\n");
      out.write("\t\t\t\t\t\t\t$that.children('td').children('a[data-opt=seeDesc]').on('click', function() {\n");
      out.write("\t\t\t\t\t\t\t\tvar id = $(this).data('id');// 获取id\n");
      out.write("\t\t\t\t\t\t\t\tlayer.open({\n");
      out.write("\t\t\t\t\t\t\t\t\t  type: 1, \n");
      out.write("\t\t\t\t\t\t\t\t\t  title: '大纲内容',\n");
      out.write("\t\t\t\t\t\t\t\t\t  shade: false,\n");
      out.write("\t\t\t\t\t\t\t\t\t  offset: 'auto',\n");
      out.write("\t\t\t\t\t\t\t\t\t  area: ['520px', '450px'],\n");
      out.write("\t\t\t\t\t\t\t\t\t  zIndex: 19891015,\n");
      out.write("\t\t\t\t\t\t\t\t\t  maxmin: true,\n");
      out.write("\t\t\t\t\t\t\t\t\t  content: '<div  style=\"text-align:center;\"><textarea style=\"width:480px;height:380px;\">'+id+'</textarea></div>' //这里content是一个普通的String\n");
      out.write("\t\t\t\t\t\t\t\t\t});\n");
      out.write("\t\t\t\t\t\t\t});\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t});\n");
      ...
      out.write("\t\t\t\t\t\t\t\t$.get('dagang-edit', {id:id}, function(form) {\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t  url: '/pic/upload'\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t  ,elem:'.uploadimage'\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t  ,before: function(input){\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t    //返回的参数item，即为当前的input DOM对象\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t  layer.load();\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t  }\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t  ,success: function(res,input){\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t  layer.closeAll('loading');\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t  if (res.error == 0) {\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t \t $(\"#upImage\").val(res.url);\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t  }else {\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t  layer.msg('网络异常，请稍后重试！');\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t  }\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t  }\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t});\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tlayui.upload({\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t  url: '/record/upload'\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t  ,elem:'.uploadrecord'\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t  ,before: function(input){\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t//返回的参数item，即为当前的input DOM对象\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tlayer.load();\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t  }\n");
      ...
      out.write("\t\t\t\t\t\tif($cbx) {\n");
      out.write("\t\t\t\t\t\t\tvar n = $that.children('td:last-child').children('a[data-opt=edit]').data('id');\n");
      out.write("\t\t\t\t\t\t\tids += n + ',';\n");
      out.write("\t\t\t\t\t\t}\n");
      out.write("\t\t\t\t\t});\n");
      out.write("\t\t\t\t\t//后台删除内容\n");
      out.write("\t\t\t\t\tlayer.confirm('您确认删除吗?', {icon: 3, title:'提示'}, function(index){\n");
      out.write("\t\t\t\t\t\t  //do something\n");
      out.write("\t\t\t\t\t\t  $.get(\"deleteAllDagang\",{ids:ids},function(data){\n");
      out.write("\t\t\t\t\t\t//返回结果并刷新页面\n");
      out.write("\t\t\t\t\t\t   layerTips.msg(data.msg,{time:500},function(){\n");
      out.write("\t\t\t\t\t\t\t   layerTips.close(index);\n");
      out.write("\t\t\t\t\t\t\t\tlocation.reload(); //刷新\n");
      ...
      out.write("\t\t\t\t\t\treturn;\n");
      out.write("\t\t\t\t\t//本表单通过ajax加载 --以模板的形式，当然你也可以直接写在页面上读取\n");
      out.write("\t\t\t\t\t$.get('dagang-add', null, function(form) {\n");
      out.write("\t\t\t\t\t\taddBoxIndex = layer.open({\n");
      out.write("\t\t\t\t\t\t\ttype: 1,\n");
      out.write("\t\t\t\t\t\t\ttitle: '添加反馈',\n");
      out.write("\t\t\t\t\t\t\tcontent: form,\n");
      out.write("\t\t\t\t\t\t\tbtn: ['保存', '取消'],\n");
      out.write("\t\t\t\t\t\t\tshade: false,\n");
      out.write("\t\t\t\t\t\t\toffset: 'auto',\n");
      out.write("\t\t\t\t\t\t\tarea: ['520px', '510px'],\n");
      out.write("\t\t\t\t\t\t\tzIndex: 19891015,\n");
      out.write("\t\t\t\t\t\t\tmaxmin: true,\n");
      out.write("\t\t\t\t\t\t\tyes: function(index) {\n");
      out.write("\t\t\t\t\t\t\t\t//触发表单的提交事件\n");
